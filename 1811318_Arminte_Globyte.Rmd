...
author: "Armintė Globytė, 1811318" 
...
```{r}
#Compensation of employees yra D1
...
```{r}
aggregate(df$values,list(df$geo),mean)
```
...
ggplot(df,aes(x=time,y=values))+
        ...
        scale_x_date(date_labels = "%Y",
                     date_breaks = "1 year")+
        labs(title = "Darbo pajamu ir BVP santykis 2000-2018 metais(procentais)",
             subtitle = "Saltinis:Eurostat(namq_10_gdp)",
             x="Laikotarpis",
             y="Darbo pajamu ir BVP santykis")
```
